...
| Patched R3D importer | `third_party/r3d-importer`; [source pins, patch, rebuild instructions, and notices](third_party/r3d-importer/README.md) | Used by Rune's bridge on Windows/Linux AMD64. Rebuild and validate alongside r3d-odin upgrades. |

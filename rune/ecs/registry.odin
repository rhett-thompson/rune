...
register_builtin_components :: proc(registry: ^Component_Registry) -> bool {
	...
	return transform_registered && sprite_registered && mesh_registered && sphere_registered && model_registered && box_collider_registered && character_controller_registered && orbit_registered && rotator_registered && camera_2d_registered && camera_3d_registered && audio_listener_registered && audio_player_registered
}

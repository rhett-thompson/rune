...
material_view_path :: proc(view: Material_View) -> string {
	...
	case .Albedo:
		return "assets/materials/crate_albedo_debug.material.json"
	case .Normal:
		return "assets/materials/crate_normal_debug.material.json"
	case .Roughness:
		return "assets/materials/crate_roughness_debug.material.json"
	case .Occlusion:
		return "assets/materials/crate_ao_debug.material.json"
	case .Height:
		return "assets/materials/crate_height_debug.material.json"
	case .Metallic:
		return "assets/materials/crate_metallic_debug.material.json"
	}
	return "assets/materials/crate.material.json"
}
